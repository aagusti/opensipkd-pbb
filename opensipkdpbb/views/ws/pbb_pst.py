...
from ...models.pbb import pbbDBSession
from ...models.pbb.pst import (
    PstPermohonan,
    PstLampiran,
    PstDetail,
    PstDataOpBaru,
...
def set_pst(request, data):
    ...
    for r in data['data']:
        if 1==1:
            ...
            pbbDBSession.add(pstPermohonan)
            pbbDBSession.flush()
            ...
            if pstdataopbaru(r):
                ...
                pbbDBSession.add(pstDataOpBaru)
                pbbDBSession.flush()
            ...
            if pstpengurangan(r):
                ...
                pbbDBSession.add(pstPengurangan)
                pbbDBSession.flush()
